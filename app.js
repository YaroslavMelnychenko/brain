...
var clearButton = document.getElementById('clear').addEventListener('click', function(e) {
    e.preventDefault();
    d.clear();
});

var vectorizeButton = document.getElementById('vectorize').addEventListener('click', function(e) {
    e.preventDefault();
...
var guessButton = document.getElementById('guess').addEventListener('click', function(e) {
    e.preventDefault();
